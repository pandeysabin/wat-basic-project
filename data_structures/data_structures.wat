(module
    ...
    (global $obj_count (import "env" "obj_base_addr") i32)
    ...
    (func $collision_check
        ...
        local.get $r_sum_sq
        i32.mul
        local.tee $r_sum_sq ;; ($r1 - $r2) * ($r1 - $r2)add


        local.get $x_diff_sq
        local.get $y_diff_sq
        i32.add ;; pythagorean theorm A squared + B squared = C squared
        ...
        (loop $outer_loop
            ...
            (loop $inner_loop
                (block $inner_continue
                    ...
                    ;; local $i_obj + $x_offset and store in $xi
                    ...
                    (call $collision_check
                        (local.get $xi)(local.get $yi)(local.get $rj)
