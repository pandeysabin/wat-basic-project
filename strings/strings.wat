(module
    ...
    (func $string_copy
        ...
        if                  ;; if the last 3 bits of 4len is not 000
            local.get $len
            local.get $singles
            i32.sub
            ...
            local.get $dest
            i32.add
            local.set $start_dest_byte      ;; $start_dest_byte=$dest+$len+less_singles
        ...
        i32.and                 ;; set hte last three bits of the length to 0
        local.set $len
